...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "rounded-[1rem] sm:rounded-[1.5rem] font-black transition-all duration-700 flex items-center justify-center space-x-2 sm:space-x-3 focus:outline-none overflow-hidden relative group tracking-tight sm:tracking-wide";
