  ...
  return (
    <>
      ...
      <motion.nav 
        ...
        className="fixed bottom-0 left-0 right-0 w-full z-50 bg-white/95 backdrop-blur-md border-t border-zinc-200 px-0.5 py-2 md:hidden flex justify-around items-center rounded-t-2xl shadow-xl pb-safe"
      >
        {[
          { m: AppMode.LEARN, i: <BookIcon />, l: '學習' },
          { m: AppMode.LISTENING, i: <EarIcon />, l: '聽力' },
