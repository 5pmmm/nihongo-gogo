...
今日は朝から天気が良かったです。午前中に近くの公園を散步しました。公園にはたくさんの桜が咲いていました..."
                className="w-full h-56 resize-none border-0 p-1 bg-transparent text-zinc-800 text-sm sm:text-base font-bold focus:ring-0 placeholder:text-zinc-300 placeholder:font-normal leading-relaxed overflow-y-auto outline-none focus:outline-none"
                disabled={isLoading}
              />
